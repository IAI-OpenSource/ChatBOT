                        ...
                        <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    {...register("username")}
                                    className={`w-full border rounded-xl px-4 py-3 text-sm shadow-sm transition-all duration-300 focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none bg-zinc-900 text-white placeholder:text-zinc-600 ${errors.username ? "border-destructive" : "border-zinc-800"
                                        }`}
                                />
                                {errors.username && (
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        placeholder="••••••••"
                                        {...register("password")}
                                        className={`w-full border rounded-xl px-4 py-3 text-sm shadow-sm transition-all duration-300 focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none bg-zinc-900 text-white placeholder:text-zinc-600 ${errors.password ? "border-destructive" : "border-zinc-800"
                                            }`}
                                    />
                                    <button
                                        type="button"
                            ...
                            <button
                                type="submit"
                                disabled={isLoading}
                                className="w-full py-4 rounded-xl font-bold tracking-wide shadow-lg bg-white text-black transition-all duration-300 hover:bg-zinc-200 active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                            >
                                {isLoading ? (
                                    <>
